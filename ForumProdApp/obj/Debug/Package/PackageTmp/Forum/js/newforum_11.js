...
$(document).on("pageshow", "#welcomePage", function () { 
    ...
    else
    {
     ...
     $('#numberofRequests_lbl').click(function () {
        sessionStorage.lnk = "tableValues";
     ...
     $('#donelink').click(function () {
        sessionStorage.lnk = "DonetableValues";
        $.mobile.changePage("#page1", {
                        transition: "none"});  
     });
     $('#numberofRequestsdone_lbl').click(function () {
        sessionStorage.lnk = "DonetableValues";
        $.mobile.changePage("#page1", {
                        transition: "none"});  
     });
   
     alert('shlomi is here 3');
     $.ajax({
            type: "POST",
            ...
            success: function (msg) {
               ...
               $('#popupBasic').popup("close");
                  ...
                  console.log(aa);
                    alert('shlomi is here 4');
                    
                  // $('#hello_id').text(aa);
                    //sessionStorage.curruser = aa;
                    alert('shlomi is here 4.5');
                }
            },
        ...
        alert('shlomi is here 5');
                    ...
                    alert('shlomi is here 6');
                     $.ajax({
                        ...
                        dataType: "json",
                        success: function (msg) {
                            alert('shlomi is here 7');  
                            // Replace the div's content with the page method's return.
                            DonetableValues = $.parseJSON(msg.d);
                              alert('shlomi is here 8');  
                            localStorage.DonetableValues = msg.d;

                            $('#numberofRequestsdone_lbl').text(DonetableValues.length);
                            if(DonetableValues.length > 0) 
                                $('#numberofRequestsdone_lbl').css('color', 'green');
                            else
                                $('#numberofRequestsdone_lbl').css('color', 'gray');
                             $('#popupBasic').popup("close");
                             alert('shlomi is here 11'); 
                        },
                        error: function (xhr, ajaxOptions, thrownError) {
                              $('#popupBasic').popup("close");
...
alert('shlomi is here 22');  
            $.ajax({
                        ...
                        dataType: "json",
                        success: function (msg) {
                            alert('shlomi is here 23');  
                            // Replace the div's content with the page method's return.
                            DonetableValues = $.parseJSON(msg.d);
                            localStorage.DonetableValues = msg.d;
                            $('#numberofRequestsdone_lbl').text(DonetableValues.length);
                             $('#popupBasic').popup("close");
                            alert('shlomi is here 24');  
                        },
                        error: function (xhr, ajaxOptions, thrownError) {
                              $('#popupBasic').popup("close");
                              alert('כשלון בפניה לשרת - אנא פנה לצוות כלים אוטומטים - GetDoneForumForMe');
